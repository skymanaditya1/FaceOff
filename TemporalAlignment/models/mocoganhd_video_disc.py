# This is the mocoganhd motion (video) discriminator code
import numpy as np
import torch
import torch.nn as nn
import functools

# this is the discriminator for classifying the real/fake video motion (video code)
class ModelD_3d(nn.Module):
    def __init__(self, nc, norm_D_3d, num_D, lr, cross_domain, n_frames_G):
        super(ModelD_3d, self).__init__()
        if cross_domain:
            nc = nc
            n_frames_G = n_frames_G
        else:
            nc = nc * 2
